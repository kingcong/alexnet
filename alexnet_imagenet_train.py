...
from mindvision.classification.models import alex
...
def alexnet_train(args_opt):
    ...
    network = alex(
        ...
        num_channel=args_opt.num_channel,
        dropout=args_opt.droptout,
    ...
    if args_opt.lr_decay_mode == 'cosine_decay_lr':
        ...
        lr = nn.piecewise_constant_lr(
            args_opt.milestone, args_opt.learning_rates)
    ...
    ckpt_callback = ModelCheckpoint(prefix='alexnet',
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='AlexNet train.')
    ...
    parser.add_argument('--ckpt_save_dir', type=str, default="./alexnet", help='Location of training outputs.')
    ...
    parser.add_argument('--num_channel', type=int, default=3, help='Number of input channels.')
    ...
    parser.add_argument('--milestone', type=list, default=[150, 225, 300], help='A list of milestone.')
    parser.add_argument('--learning_rate', type=list, default=[0.1, 0.01, 0.001], help='A list of learning rate')
